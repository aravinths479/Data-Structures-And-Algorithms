...
public class houseRobber2 {
    public static int robFunction(int nums[] , int start , int end){
        int left = nums[start];
    ...
    public static int rob(int[] nums) {
        ...
        int withFirstHouse = robFunction(nums, 0, nums.length-2);
        int withLastHouse = robFunction(nums , 1, nums.length-1);
